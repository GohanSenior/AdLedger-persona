...
class Criteria_types extends Model
{
    ...
    public function getCriteriaTypeById($id_criteria_type)
    {
    ...
    public function createCriteriaType($criteria_type_name)
    {
    ...
    public function updateCriteriaType($id_criteria_type, $criteria_type_name)
    {
