<div class="container d-flex justify-content-center div-container">
    <div class="text-center form-wrapper">
        <div class="card p-4 mb-5 rounded-4 form-card">
            <a href="<?= $editMode ? htmlspecialchars($redirect, ENT_QUOTES, 'UTF-8') : 'index.php' ?>" id="closeBtn">
            ...
            <?php endif; ?>
            <form action="<?= $editMode ? 'index.php?action=edit-persona&id=' . $persona['id_persona'] . '&redirect=' . urlencode($redirect ?? '') : 'index.php?action=create-persona' ?>" method="post">
